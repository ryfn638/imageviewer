...
/// tlVecReserve()
/// Reserves a vector with space, in other words puts the data into a different
/// memory bucket.
/// TODO: Write error warnings to preven this from causing segmentation faults
...
///@param freeOther
///
void tlVecJoin(tlVector *inputVector, tlVector *rhsVector,
               const tlBool freeOther);
